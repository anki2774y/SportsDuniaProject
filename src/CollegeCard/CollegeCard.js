...
import styled from './CollegeCard.module.css';
import { collegeSelector } from '../redux/reducer/collegeReducer';

function CollegeCard () {

    const colleges = useSelector(collegeSelector);
                ...
                <tr>
                    ...
                    <td className={styled.userReviews}>
                        <span className={styled.rating}>
                            ...
                            <p> {college.userReviews.rating} / 10 </p>
                        </span>
